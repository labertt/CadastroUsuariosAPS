...
from validacao.validators import validacao_nome, validacao_cpf, validacao_endereco, validacao_data
...
class Aluno(models.Model):
    ...
    data_nascimento_aluno = models.DateField(validators=[validacao_data])
